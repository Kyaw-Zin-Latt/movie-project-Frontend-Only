            ...
            <div class="my-5">
                <div class="d-flex align-items-center justify-content-center mb-4">
                    <span class="bg-primary p-2 rounded d-flex justify-content-center align-items-center mr-2">
                        <i class="fas fa-store-alt text-white h4 mb-0"></i>
                    </span>
...
//                                  header("Location:login.php");
                                    echo showAlert("success","Congralution,your account has been successfully created");
                                }else{
                                    echo showAlert("danger","Password and Confrim Password does not match");
                                }
                        ...
                        <form action="" method="post">
                            ...
                            <button type="submit" class="btn btn-lg btn-block btn-primary w-100" name="register">Sign Up</button>
                        </form>
                    </div>
                </div>
            </div>
